...
// Create new property (admin/editor only)
router.post('/', authenticateToken, requireAdminOrEditor, validateProperty, validateRequest, asyncHandler(async (req, res) => {
  const { title, price, location, description, features, images, status } = req.body;
...
router.put('/:id', authenticateToken, requireAdminOrEditor, validateProperty, validateRequest, asyncHandler(async (req, res) => {
  const { title, price, location, description, features, images, status } = req.body;
